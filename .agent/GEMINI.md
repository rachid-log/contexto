...
*   Command: `source .venv/bin/activate && python3 ./context/fetch_memories.py <COUNT>`
*   Example: `source .venv/bin/activate && python3 ./context/fetch_memories.py 5` (fetches the last 5 executed tasks).
...
*   Command: `source .venv/bin/activate && python3 ./context/fetch_memories.py --search "<YOUR_QUERY>"`
*   Example: `source .venv/bin/activate && python3 ./context/fetch_memories.py --search "OAuth2 token implementation"`
...
*   Command: `source .venv/bin/activate && python3 ./context/append_memory.py "<YOUR_MEMORY_TEXT>"`
*   Example: `source .venv/bin/activate && python3 ./context/append_memory.py "Refactored the core authentication flow, replacing sessions with JWT tokens."`
